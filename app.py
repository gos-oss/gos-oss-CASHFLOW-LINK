...
if uploaded_file is not None and hoja_seleccionada is not None:
    try:
        ...
        # =====================================================================
        # 5. CREACIÓN DE PESTAÑAS Y VISUALIZACIÓN DEL DASHBOARD
        # =====================================================================
        # Aquí definimos tab_matriz, evitando el NameError
        tab_dashboard, tab_matriz, tab_analisis = st.tabs([
            "📊 Dashboard Ejecutivo", 
            "📁 Matriz Segmentada", 
            "🍩 Análisis de Rubros"
        ])
        ...
        with tab_matriz:
            ...
            if idx_ingresos_list and idx_egresos_list:
                ...
                # Rebanamos (Slicing) la tabla en 3 bloques lógicos
